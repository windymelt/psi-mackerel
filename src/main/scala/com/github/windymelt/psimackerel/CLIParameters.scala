...
object CLIParameters:
  ...
  val apiKeyForPsi = Opts
    .option[String](
      "psi-api-key",
      metavar = "API_KEY_FOR_PSI",
      help = "Optional: Set PSI API key (can get yours at https://developers.google.com/speed/docs/insights/v5/get-started)." +
        "API may return 429 Too Many Requests error unless you give no API key."
    )
    .orNone
